...
export const UpdateTopic: React.FC<UpdateTopicProps> = ({
  isOpen,
  onClose,
  onSubmit,
  initialData
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="w-6 h-6 flex items-center justify-center">
                  <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.99976 0C13.9027 0 17.7361 2.23654 19.8943 6.55273C20.0351 6.83419 20.035 7.16579 19.8943 7.44727C17.7361 11.7638 13.9029 14 9.99976 14C6.09674 13.9999 2.26338 11.7636 0.105225 7.44727C-0.0353444 7.16585 -0.0354717 6.83411 0.105225 6.55273C2.2634 2.2365 6.09678 0.000127203 9.99976 0ZM9.99976 4C8.34314 4.00021 6.99994 5.34338 6.99976 7C6.99976 8.65677 8.34303 9.99979 9.99976 10C11.6567 10 12.9998 8.6569 12.9998 7C12.9996 5.34326 11.6565 4 9.99976 4Z" fill="#5E8C7D"/>
                  </svg>
                </div>
              </div>
            )}
